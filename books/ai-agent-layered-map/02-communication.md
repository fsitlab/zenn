...
1. [通信層の概要](#1-通信層の概要)
2. [2層A：クライアント起点の通信](#2-2層aクライアント起点の通信)
3. [2層B：LLM起点の通信](#3-2層bllm起点の通信)
4. [ストリーミング](#4-ストリーミング)
...
|--|--|--|
| `model` | リクエストルート | 第1層 |
| `system` / `messages` | リクエストルート | 第1層（構造）+ 第2層A（内容） |
| `tools[]` | リクエストルート | 第1層（構造）+ 第2層A（宣言） |
| `tool_choice` | リクエストルート | 第2層A |
